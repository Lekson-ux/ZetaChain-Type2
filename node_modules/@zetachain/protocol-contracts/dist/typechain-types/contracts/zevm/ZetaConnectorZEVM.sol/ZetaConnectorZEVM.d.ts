...
export interface ZetaConnectorZEVMInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "FUNGIBLE_MODULE_ADDRESS" | "send" | "setWzetaAddress" | "wzeta"): FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "setWzetaAddress", values: [PromiseOrValue<string>]): string;
    ...
    decodeFunctionResult(functionFragment: "setWzetaAddress", data: BytesLike): Result;
...
export interface ZetaConnectorZEVM extends BaseContract {
    ...
    functions: {
        ...
        setWzetaAddress(wzeta_: PromiseOrValue<string>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        setWzetaAddress(wzeta_: PromiseOrValue<string>, overrides?: CallOverrides): Promise<void>;
        wzeta(overrides?: CallOverrides): Promise<string>;
    };
    filters: {
