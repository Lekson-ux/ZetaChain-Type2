...
export interface ERC20CustodyInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "TSSAddress" | "TSSAddressUpdater" | "deposit" | "pause" | "paused" | "renounceTSSAddressUpdater" | "unpause" | "unwhitelist" | "updateTSSAddress" | "updateZetaFee" | "whitelist" | "whitelisted" | "withdraw" | "zeta" | "zetaFee" | "zetaMaxFee"): FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "unwhitelist", values: [PromiseOrValue<string>]): string;
    encodeFunctionData(functionFragment: "updateTSSAddress", values: [PromiseOrValue<string>]): string;
    encodeFunctionData(functionFragment: "updateZetaFee", values: [PromiseOrValue<BigNumberish>]): string;
    ...
    encodeFunctionData(functionFragment: "zetaMaxFee", values?: undefined): string;
    ...
    decodeFunctionResult(functionFragment: "updateZetaFee", data: BytesLike): Result;
...
export type RenouncedTSSUpdaterEventFilter = TypedEventFilter<RenouncedTSSUpdaterEvent>;
...
export type UpdatedTSSAddressEventFilter = TypedEventFilter<UpdatedTSSAddressEvent>;
...
export interface ERC20Custody extends BaseContract {
    ...
    functions: {
        ...
        deposit(recipient: PromiseOrValue<BytesLike>, asset: PromiseOrValue<string>, amount: PromiseOrValue<BigNumberish>, message: PromiseOrValue<BytesLike>, overrides?: Overrides & {
        ...
        unwhitelist(asset: PromiseOrValue<string>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        updateTSSAddress(TSSAddress_: PromiseOrValue<string>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        updateZetaFee(zetaFee_: PromiseOrValue<BigNumberish>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        whitelist(asset: PromiseOrValue<string>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        whitelisted(arg0: PromiseOrValue<string>, overrides?: CallOverrides): Promise<[boolean]>;
        withdraw(recipient: PromiseOrValue<string>, asset: PromiseOrValue<string>, amount: PromiseOrValue<BigNumberish>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        TSSAddress(overrides?: CallOverrides): Promise<string>;
        TSSAddressUpdater(overrides?: CallOverrides): Promise<string>;
        deposit(recipient: PromiseOrValue<BytesLike>, asset: PromiseOrValue<string>, amount: PromiseOrValue<BigNumberish>, message: PromiseOrValue<BytesLike>, overrides?: CallOverrides): Promise<void>;
        pause(overrides?: CallOverrides): Promise<void>;
        paused(overrides?: CallOverrides): Promise<boolean>;
        renounceTSSAddressUpdater(overrides?: CallOverrides): Promise<void>;
        unpause(overrides?: CallOverrides): Promise<void>;
        unwhitelist(asset: PromiseOrValue<string>, overrides?: CallOverrides): Promise<void>;
        updateTSSAddress(TSSAddress_: PromiseOrValue<string>, overrides?: CallOverrides): Promise<void>;
        updateZetaFee(zetaFee_: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<void>;
        whitelist(asset: PromiseOrValue<string>, overrides?: CallOverrides): Promise<void>;
        whitelisted(arg0: PromiseOrValue<string>, overrides?: CallOverrides): Promise<boolean>;
        withdraw(recipient: PromiseOrValue<string>, asset: PromiseOrValue<string>, amount: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<void>;
        zeta(overrides?: CallOverrides): Promise<string>;
        zetaFee(overrides?: CallOverrides): Promise<BigNumber>;
        zetaMaxFee(overrides?: CallOverrides): Promise<BigNumber>;
    };
    filters: {
        "Deposited(bytes,address,uint256,bytes)"(recipient?: null, asset?: PromiseOrValue<string> | null, amount?: null, message?: null): DepositedEventFilter;
        Deposited(recipient?: null, asset?: PromiseOrValue<string> | null, amount?: null, message?: null): DepositedEventFilter;
        "Paused(address)"(sender?: null): PausedEventFilter;
        Paused(sender?: null): PausedEventFilter;
        "RenouncedTSSUpdater(address)"(TSSAddressUpdater_?: null): RenouncedTSSUpdaterEventFilter;
        RenouncedTSSUpdater(TSSAddressUpdater_?: null): RenouncedTSSUpdaterEventFilter;
        "Unpaused(address)"(sender?: null): UnpausedEventFilter;
        Unpaused(sender?: null): UnpausedEventFilter;
        "Unwhitelisted(address)"(asset?: PromiseOrValue<string> | null): UnwhitelistedEventFilter;
        Unwhitelisted(asset?: PromiseOrValue<string> | null): UnwhitelistedEventFilter;
        "UpdatedTSSAddress(address)"(TSSAddress_?: null): UpdatedTSSAddressEventFilter;
        ...
        "Whitelisted(address)"(asset?: PromiseOrValue<string> | null): WhitelistedEventFilter;
        Whitelisted(asset?: PromiseOrValue<string> | null): WhitelistedEventFilter;
        "Withdrawn(address,address,uint256)"(recipient?: PromiseOrValue<string> | null, asset?: PromiseOrValue<string> | null, amount?: null): WithdrawnEventFilter;
        Withdrawn(recipient?: PromiseOrValue<string> | null, asset?: PromiseOrValue<string> | null, amount?: null): WithdrawnEventFilter;
    };
    estimateGas: {
