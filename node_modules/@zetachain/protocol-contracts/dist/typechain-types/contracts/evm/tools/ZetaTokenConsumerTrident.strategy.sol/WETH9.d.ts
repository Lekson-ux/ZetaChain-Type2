...
export interface WETH9Interface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "deposit" | "depositTo" | "withdraw" | "withdrawTo"): FunctionFragment;
...
export interface WETH9 extends BaseContract {
    ...
    functions: {
        ...
        depositTo(to: PromiseOrValue<string>, overrides?: PayableOverrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        withdraw(wad: PromiseOrValue<BigNumberish>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        withdrawTo(to: PromiseOrValue<string>, value: PromiseOrValue<BigNumberish>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
    };
    deposit(overrides?: PayableOverrides & {
    ...
    callStatic: {
        ...
        depositTo(to: PromiseOrValue<string>, overrides?: CallOverrides): Promise<void>;
        withdraw(wad: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<void>;
        withdrawTo(to: PromiseOrValue<string>, value: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<void>;
    };
    filters: {};
    estimateGas: {
        deposit(overrides?: PayableOverrides & {
