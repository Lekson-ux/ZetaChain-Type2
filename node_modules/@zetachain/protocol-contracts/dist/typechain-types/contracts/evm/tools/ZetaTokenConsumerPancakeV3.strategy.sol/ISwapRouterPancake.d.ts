...
export interface ISwapRouterPancakeInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "exactInput" | "exactInputSingle" | "uniswapV3SwapCallback"): FunctionFragment;
    encodeFunctionData(functionFragment: "exactInput", values: [ISwapRouterPancake.ExactInputParamsStruct]): string;
    encodeFunctionData(functionFragment: "exactInputSingle", values: [ISwapRouterPancake.ExactInputSingleParamsStruct]): string;
...
export interface ISwapRouterPancake extends BaseContract {
    ...
    functions: {
        exactInput(params: ISwapRouterPancake.ExactInputParamsStruct, overrides?: PayableOverrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        exactInputSingle(params: ISwapRouterPancake.ExactInputSingleParamsStruct, overrides?: PayableOverrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        exactInput(params: ISwapRouterPancake.ExactInputParamsStruct, overrides?: CallOverrides): Promise<BigNumber>;
        exactInputSingle(params: ISwapRouterPancake.ExactInputSingleParamsStruct, overrides?: CallOverrides): Promise<BigNumber>;
