...
export type MockOnZetaMessageEventFilter = TypedEventFilter<MockOnZetaMessageEvent>;
...
export type MockOnZetaRevertEventFilter = TypedEventFilter<MockOnZetaRevertEvent>;
export interface ZetaReceiverMock extends BaseContract {
    ...
    filters: {
        "MockOnZetaMessage(address)"(destinationAddress?: null): MockOnZetaMessageEventFilter;
