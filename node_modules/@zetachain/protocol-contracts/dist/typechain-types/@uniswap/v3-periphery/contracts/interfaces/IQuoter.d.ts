...
export interface IQuoter extends BaseContract {
    ...
    functions: {
        ...
        quoteExactInputSingle(tokenIn: PromiseOrValue<string>, tokenOut: PromiseOrValue<string>, fee: PromiseOrValue<BigNumberish>, amountIn: PromiseOrValue<BigNumberish>, sqrtPriceLimitX96: PromiseOrValue<BigNumberish>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        quoteExactOutput(path: PromiseOrValue<BytesLike>, amountOut: PromiseOrValue<BigNumberish>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        quoteExactOutputSingle(tokenIn: PromiseOrValue<string>, tokenOut: PromiseOrValue<string>, fee: PromiseOrValue<BigNumberish>, amountOut: PromiseOrValue<BigNumberish>, sqrtPriceLimitX96: PromiseOrValue<BigNumberish>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
    };
    quoteExactInput(path: PromiseOrValue<BytesLike>, amountIn: PromiseOrValue<BigNumberish>, overrides?: Overrides & {
